    ...
    override fun onMessageReceived(event: MessageReceivedEvent) {
        ...
        if (event.jda.selfUser in event.message.mentionedUsers) {
            if ("good bot" in content) {
                ...
                builder.setDescription("What the fuck did you just fucking say about me, you little bitch? I'll " +
                    "have you know I graduated top of my class in the Navy Seals, and I've been involved in numerous " +
                    "secret raids on Al-Quaeda, and I have over 300 confirmed kills. I am trained in gorilla " +
                    ...
                    "shit to me over the Internet? Think again, fucker. As we speak I am contacting my secret network " +
                    "of spies across the USA and your IP is being traced right now so you better prepare for the " +
                    ...
                    "down upon you, maybe you would have held your fucking tongue. But you couldn't, you didn't, and " +
                    "now you're paying the price, you goddamn idiot. I will shit fury all over you and you will " +
